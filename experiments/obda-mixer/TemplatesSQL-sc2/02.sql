...
FROM "product1" v6
WHERE (v6."label" IS NOT NULL AND (v6."nr" <= ${1:product.nr:percent}))
UNION ALL
SELECT v8."label" AS "label10m46", v8."nr" AS "nr2m3"
FROM "product2" v8
WHERE (v8."label" IS NOT NULL AND (v8."nr" <= ${1:product.nr:percent}))
) v10 ON 1 = 1
 JOIN
(SELECT v11."comment" AS "comment10m20", v11."nr" AS "nr2m4"
FROM "product1" v11
WHERE (v11."comment" IS NOT NULL AND (v11."nr" <= ${1:product.nr:percent}))
UNION ALL
SELECT v13."comment" AS "comment10m20", v13."nr" AS "nr2m4"
FROM "product2" v13
WHERE (v13."comment" IS NOT NULL AND (v13."nr" <= ${1:product.nr:percent}))
) v15 ON 1 = 1
 JOIN
(SELECT v17."label" AS "label10m5", v16."nr" AS "nr2m5", v16."producer" AS "producer2m9"
FROM "product1" v16, "producer" v17
WHERE ((v16."nr" <= ${1:product.nr:percent}) AND v17."label" IS NOT NULL AND v16."producer" = v17."nr")
UNION ALL
SELECT v20."label" AS "label10m5", v19."nr" AS "nr2m5", v19."producer" AS "producer2m9"
FROM "product2" v19, "producer" v20
WHERE ((v19."nr" <= ${1:product.nr:percent}) AND v20."label" IS NOT NULL AND v19."producer" = v20."nr")
) v22 ON 1 = 1
 JOIN
(SELECT v23."nr" AS "nr2m7", v23."producer" AS "producer2m6"
FROM "product1" v23
WHERE (v23."producer" IS NOT NULL AND (v23."nr" <= ${1:product.nr:percent}))
UNION ALL
SELECT v25."nr" AS "nr2m7", v25."producer" AS "producer2m6"
FROM "product2" v25
WHERE (v25."producer" IS NOT NULL AND (v25."nr" <= ${1:product.nr:percent}))
) v27 ON 1 = 1
 JOIN
...
FROM "product1" v35
WHERE (v35."propertytex1" IS NOT NULL AND (v35."nr" <= ${1:product.nr:percent}))
UNION ALL
SELECT v37."nr" AS "nr2m9", v37."propertytex1" AS "propertytex1m34"
FROM "product2" v37
WHERE (v37."propertytex1" IS NOT NULL AND (v37."nr" <= ${1:product.nr:percent}))
) v39 ON 1 = 1
 JOIN
(SELECT v40."nr" AS "nr2m10", v40."propertytex2" AS "propertytex1m33"
FROM "product1" v40
WHERE (v40."propertytex2" IS NOT NULL AND (v40."nr" <= ${1:product.nr:percent}))
UNION ALL
SELECT v42."nr" AS "nr2m10", v42."propertytex2" AS "propertytex1m33"
FROM "product2" v42
WHERE (v42."propertytex2" IS NOT NULL AND (v42."nr" <= ${1:product.nr:percent}))
) v44 ON 1 = 1
 JOIN
(SELECT v45."nr" AS "nr2m11", v45."propertytex3" AS "propertytex1m32"
FROM "product1" v45
WHERE (v45."propertytex3" IS NOT NULL AND (v45."nr" <= ${1:product.nr:percent}))
UNION ALL
SELECT v47."nr" AS "nr2m11", v47."propertytex3" AS "propertytex1m32"
FROM "product2" v47
WHERE (v47."propertytex3" IS NOT NULL AND (v47."nr" <= ${1:product.nr:percent}))
) v49 ON 1 = 1
 JOIN
(SELECT v50."nr" AS "nr2m12", v50."propertynum1" AS "propertynum1m41"
FROM "product1" v50
WHERE (v50."propertynum1" IS NOT NULL AND (v50."nr" <= ${1:product.nr:percent}))
UNION ALL
SELECT v52."nr" AS "nr2m12", v52."propertynum1" AS "propertynum1m41"
FROM "product2" v52
WHERE (v52."propertynum1" IS NOT NULL AND (v52."nr" <= ${1:product.nr:percent}))
) v54 ON 1 = 1
 JOIN
(SELECT v55."nr" AS "nr2m13", v55."propertynum2" AS "propertynum1m40"
FROM "product1" v55
WHERE (v55."propertynum2" IS NOT NULL AND (v55."nr" <= ${1:product.nr:percent}))
UNION ALL
SELECT v57."nr" AS "nr2m13", v57."propertynum2" AS "propertynum1m40"
FROM "product2" v57
WHERE (v57."propertynum2" IS NOT NULL AND (v57."nr" <= ${1:product.nr:percent}))
