...
WHERE ((v1."nr" <= ${1:offer.nr:none}) AND v2."label" IS NOT NULL AND v3."label" IS NOT NULL AND v3."homepage" IS NOT NULL AND v1."offerwebpage" IS NOT NULL AND v1."price" IS NOT NULL AND v1."deliverydays" IS NOT NULL AND v1."validto" IS NOT NULL AND v1."product" = v2."nr" AND v1."vendor" = v3."nr")
